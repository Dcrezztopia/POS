                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="{{asset('template/dist/img/default-150x150.p')}}ng" alt="Product Image" class="img-size-50">
                    </div>
...
<!-- level input -->
<div class="form-group">
<label>Level</label><input type="text" class="form-control" placeholder="level">
</div>
<!-- user input -->
<div class="form-group">
<label>User</label><input type="text" class="form-control" placeholder="user">
</div>
